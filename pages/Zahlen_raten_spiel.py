...
st.title("Zahlen Raten Spiel")
st.subheader("Rate die Nummer")
...
def spiel():
  with st.chat_message("ai"):
    st.write("Robot: Rate eine Nummer von 1 bis 10")
...
with st.bottom.expander("Code vom Programm"):
  st.code(inspect.getsource(spiel))